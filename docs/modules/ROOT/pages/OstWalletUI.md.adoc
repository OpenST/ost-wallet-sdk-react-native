...
* +++<b>+++with QR Code payload +++</b>+++ + Developer can pass QR code payload to authorize device.
QR code scanner view won't open if developer pass payload.
...
* +++<b>+++with QR Code payload +++</b>+++ + Developer can pass QR code payload to execute transaction.
QR code scanner view won't appear if developer pass payload.

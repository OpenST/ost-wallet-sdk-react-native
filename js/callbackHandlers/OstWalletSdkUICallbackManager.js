...
import callbackIntercept from './OstWalletUIWorkflowCallbackIntercept';
...
const uiCallbackInvoker = params =>  {
...
export { setInstance, getInstance, clearInstance, instantiateOstError , uiCallbackInvoker };
